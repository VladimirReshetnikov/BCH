...
every homogeneous component (through degree $10$);
...
\item the exchange parity \eqref{eq:parity} (through degree $12$), the
word-reversal parity \eqref{eq:reversal} (through degree $10$), and
three-letter associativity \eqref{eq:assoc} (through degree $6$);

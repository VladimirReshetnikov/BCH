...
including the Lie nature of the $Z_n$), the word-level majorant in the first
line of \eqref{eq:majorant}, the estimate \eqref{eq:expremainder}, parts
(iii) and (iv) of \cref{thm:convergence}, and the later sections are not yet
